    ...
    <div className=" bg-white rounded-[20px] border-t shadow flex flex-col w-[360px] pb-4 hover:bg-gray-300">
     <div className='p-2'>
      ...
      <div className='flex flex-col'>      
        <Link className="mx-6 py-2 text-center bg-[#3E5685] text-white hover:bg-blue-950 rounded-md text-[18px]" to={`/buy_productcard_info/${product.name}_${product.id}`}>ดูรายละเอียด</Link>
      </div>
    </div>
